...
API_KEY = "10f73b718e8240b2a8493911251504"
...
def get_multiple_city_weather(cities):
    ...
    for city in cities:
        ...
        if data:
            ...
            weather_data[city] = "Veri alınamadı"
    return weather_data
...
def save_weather_to_csv(city, weather_data):
    with open(f'{city}_weather.csv', mode='w', newline='') as file:
        ...
        writer.writerow([weather_data['location']['name'], weather_data['current']['temp_c'],
                         weather_data['current']['condition']['text'], weather_data['current']['humidity'],
